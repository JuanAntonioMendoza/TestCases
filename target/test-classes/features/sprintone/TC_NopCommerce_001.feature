Feature: TC_NopCommerce
  ...
  @Cold_User @TC_Digital_DownLoad_C_001
  ...
  @Cold_User @TC_Digital_DownLoad_C_003
  ...
  @Cold_User @TC_Digital_DownLoad_C_Detail_005
  ...
  @Cold_User @TC_Digital_DownLoad_C_Product_Review_007
  ...
  @Cold_User @TC_Digital_DownLoad_C_Cloud_Tag_009
  ...
  @Hot_User @TC_Digital_DownLoad_H_002
  Scenario: Verify Product Page from the Home search Textbox for Digital Download category for cold users
  ...
  @Hot_User @TC_Digital_DownLoad_H_004
  ...
  @Hot_User @TC_Digital_DownLoad_H_Detail_006
  ...
  @Hot_User @TC_Digital_DownLoad_h_Cloud_Tag_010
  Scenario: Verify Product Page from the Cloud Tag for Digital Download category for cold users
  ...
  @Hot_User @TC_Digital_DownLoad_H_Product_Review_008
